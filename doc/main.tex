...
% TODO
    ...
    \begin{figure}[ht]
        ...
        \begin{subfigure}{0.45\textwidth}
            \includegraphics[width=\textwidth]{fig/transformer/accuracy-adamw-0.5-2.png}
            \caption{Train percentage: 50\%}
        \end{subfigure}
        \begin{subfigure}{0.45\textwidth}
            \includegraphics[width=\textwidth]{fig/transformer/accuracy-adamw-0.4-2.png}
            \caption{Train percentage: 60\%}
        \end{subfigure}
        \begin{subfigure}{0.45\textwidth}
            \includegraphics[width=\textwidth]{fig/transformer/accuracy-adamw-0.55-2.png}
            \caption{Train percentage: 45\%}
        \end{subfigure}
        \begin{subfigure}{0.45\textwidth}
            \includegraphics[width=\textwidth]{fig/transformer/accuracy-adamw-0.6-2.png}
    ...
    \begin{figure}[ht]
        \centering
        \includegraphics[width=0.5\textwidth]{fig/transformer/loss-adamw-0.5-2.png}
...
% TODO: add MLP and LSTM grokking figure
% \includegraphics{./fig/mlp/accuracy-adam-0.5.png}
    ...
    % \includegraphics{./fig/lstm/accuracy-adam-0.5.png}
